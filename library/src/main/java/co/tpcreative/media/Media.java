...
import co.tpcreative.media.ui.camera.Camera1Activity;
import co.tpcreative.media.ui.camera2.Camera2Activity;
...
public class Media {
     ...
     */
    public Media(Activity activity, @IntRange(from = 0) int requestCode) {
        AnncaConfiguration.Builder builder = new AnncaConfiguration.Builder(activity, requestCode);
        anncaConfiguration = builder.build();
    }

    public Media(Fragment fragment, @IntRange(from = 0) int requestCode) {
     ...
     */
    public Media(AnncaConfiguration cameraConfiguration) {
