package co.tpcreative.media.manager.impl;
...
abstract class BaseCameraManager<CameraId, SurfaceListener, CameraParameters, Camera>
        implements co.tpcreative.media.manager.CameraManager<CameraId, SurfaceListener, CameraParameters, Camera>, MediaRecorder.OnInfoListener {
